...
public class GameListItem {
    ...
    public GameListItem(String id, String typeid, String title, String litpic, String senddate, String keywords, String description, String typename, String language, String arcurl, String release_company, String made_company, String terrace, String release_date, String websit) {
            this.id = id;
            this.typeid = typeid;
            this.title = title;
            this.litpic = litpic;
